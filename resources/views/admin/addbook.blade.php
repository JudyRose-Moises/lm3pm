                ...
                <div class="card">
                    ...
                    <form method="POST" action="{{ route('admin.addbook') }}">
                        ...
                        <div class="form-group">
                            ...
                            <p>Published Date:</p>
                            <input type="text" id="pdate" class="form-control" name="pdate" placeholder="Date (YYYY-MM-DD)" required>
                        </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-add btn-lg btn-block">Add Book</button>
                        </div>
                    </form>
                </div>
            </div>
